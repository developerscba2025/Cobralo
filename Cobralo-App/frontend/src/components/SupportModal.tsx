          ...
          <div className="relative z-10">
            ...
            >
              ...
              <button 
                type="submit"
                disabled={isSending}
                className={`w-full py-4 ${isSending ? 'bg-green-600/50 cursor-not-allowed' : 'bg-green-600 hover:bg-green-700'} text-white font-black rounded-2xl transition-all flex items-center justify-center gap-2 shadow-lg shadow-green-500/20`}
              >
                {isSending ? (
