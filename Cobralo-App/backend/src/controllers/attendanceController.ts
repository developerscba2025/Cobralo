...
export const getStudentAttendance = async (req: AuthRequest, res: Response) => {
    try {
        ...
        console.log(`[DEBUG] getStudentAttendance: studentId=${studentId}, userId=${req.userId}`);
        ...
        if (!student) {
            console.log(`[DEBUG] student not found for id=${studentId} and userId=${req.userId}`);
