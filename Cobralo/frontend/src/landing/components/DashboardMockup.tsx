          ...
          <div className="grid grid-cols-1 min-h-[400px]">
            ...
            <div className="p-6 md:p-8 space-y-8">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between px-2 sm:px-4 mb-4 text-[9px] sm:text-[10px] font-black text-text-dim uppercase tracking-widest">
                  <span>Alumno</span>
                  <div className="flex gap-4 sm:gap-16">
                    <span className="hidden sm:inline">Monto</span>
                    <span className="w-16 sm:w-20 text-center">Estado</span>
                  </div>
                </div>
                {[
                  ...
                  >
                    <div className="flex items-center gap-2 sm:gap-4">
                      <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-white/5 flex items-center justify-center text-[10px] sm:text-xs font-black text-primary-light">
                        {row.n[0]}
                      </div>
                      <div>
                        <div className="text-[11px] sm:text-xs font-bold text-white">{row.n}</div>
                        <div className="text-[9px] sm:text-[10px] text-text-dim font-medium">{row.s}</div>
                      </div>
                    </div>
                    <div className="flex items-center gap-4 sm:gap-8">
                      <div className="hidden sm:block text-xs font-mono font-bold text-primary-light">{row.a}</div>
                      <div className={`text-[8px] sm:text-[9px] font-black px-2 sm:px-3 py-1 sm:py-1.5 rounded-lg w-16 sm:w-20 text-center ${row.p ? 'bg-primary/10 text-primary-light border border-primary/20' : 'bg-amber-500/10 text-amber-500 border border-amber-500/20'}`}>
