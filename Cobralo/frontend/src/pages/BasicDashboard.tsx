                                        ...
                                        <tr key={student.id} className="border-b border-border-main/40 hover:bg-bg-app transition transition-colors">
                                            <td className="p-4">
                                                <div className="flex items-center gap-3">
                                                    <div className="w-8 h-8 bg-surface dark:bg-bg-app rounded-lg flex items-center justify-center text-[10px] font-black text-text-muted border border-border-main uppercase">
