        ...
        >
          ...
          <div className="relative z-10">
            <div className="flex items-center justify-between mb-8">
              <div>
                <h3 className="text-2xl font-black text-zinc-900 dark:text-emerald-50">Soporte Cobralo</h3>
                <p className="text-sm text-zinc-500 dark:text-zinc-400 mt-1">Envíanos tu mensaje y te responderemos pronto.</p>
              </div>
              <button 
                onClick={onClose}
                className="w-10 h-10 rounded-xl bg-zinc-100 dark:bg-white/5 border border-zinc-200 dark:border-white/10 flex items-center justify-center text-zinc-400 hover:text-zinc-800 dark:hover:text-white hover:bg-zinc-200 dark:hover:bg-white/10 transition-all cursor-pointer"
              >
                <X size={20} />
              </button>
            </div>
            ...
            >
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  <label className="text-[10px] uppercase font-black text-zinc-400 tracking-widest pl-1">Nombre</label>
                  <input 
                    name="name"
                    type="text" 
                    required
                ...
                <div className="space-y-1.5">
                  <label className="text-[10px] uppercase font-black text-zinc-400 tracking-widest pl-1">Email</label>
                  <input 
                    name="email"
                    type="email" 
                    required
              ...
              <div className="space-y-1.5">
                <label className="text-[10px] uppercase font-black text-zinc-400 tracking-widest pl-1">Mensaje</label>
                <textarea 
                  name="message"
                  rows={4}
                  required
                  placeholder="Escribe tu mensaje aquí..."
                  className="w-full px-4 py-3 rounded-xl bg-bg-app border border-border-main outline-none focus:border-primary-main/40 focus:ring-2 focus:ring-primary-main/10 transition-all text-sm font-medium resize-none text-text-main" 
                ></textarea>
              </div>
