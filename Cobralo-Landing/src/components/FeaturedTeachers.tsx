...
const FeaturedTeachers = () => {
  const teachers = [
    { name: 'Mariano G.', cat: 'Personal Trainer', rate: 5.0, img: 'M' },
    { name: 'Lucía F.', cat: 'Clases de Guitarra', rate: 4.9, img: 'L' },
    { name: 'Roberto S.', cat: 'Servicios Técnicos', rate: 5.0, img: 'R' },
    { name: 'Carla M.', cat: 'Asesoría Contable', rate: 4.8, img: 'C' }
  ];
