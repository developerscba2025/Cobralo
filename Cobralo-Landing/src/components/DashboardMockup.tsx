    ...
    <div className="container">
      ...
      >
        ...
        <div className="relative bg-[#080d08] rounded-[20px] overflow-hidden border border-white/5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-[200px_1fr] min-h-[500px]">
            <div className="hidden md:block p-6 border-r border-white/5 space-y-1 bg-white/[0.01]">
              {[
                ...
                <div key={item.label} className={`px-4 py-2.5 rounded-xl text-xs font-bold transition-all cursor-pointer ${item.active ? 'bg-primary text-white shadow-lg shadow-primary/20' : 'text-text-muted hover:bg-white/5 hover:text-text-light'}`}>
                  {item.label}
                </div>
              ))}
            </div>
