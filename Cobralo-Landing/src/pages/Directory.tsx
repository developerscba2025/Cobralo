...
const MOCK_TEACHERS = [
  { id: 1, name: "Lucas Ferrero", bizName: "Acordes Online", category: "M\u00fasica", bio: "Clases de guitarra y ukelele con metodolog\u00eda propia.", city: "Buenos Aires", tags: ["M\u00fasica", "Arte"], avgRating: 4.9, reviewCount: 24 },
  { id: 2, name: "Sofía Rodriguez", bizName: "Namaste Yoga", category: "Bienestar", bio: "Instructora certificada de Hatha y Vinyasa Yoga.", city: "CABA", tags: ["Yoga", "Salud"], avgRating: 4.8, reviewCount: 18 },
  { id: 3, name: "Enzo Rossi", bizName: "Rossi Coaching", category: "Fitness", bio: "Personal trainer enfocado en entrenamiento funcional.", city: "C\u00f3rdoba", tags: ["Deportes", "Salud"], avgRating: 5.0, reviewCount: 12 },
  { id: 4, name: "Micaela Paz", bizName: "Ingl\u00e9s al D\u00eda", category: "Idiomas", bio: "Preparaci\u00f3n para ex\u00e1menes internacionales y conversaci\u00f3n.", city: "Rosario", tags: ["Educaci\u00f3n", "Idiomas"], avgRating: 4.7, reviewCount: 31 }
];
                ...
                >
                  ...
                  <div className="flex-1 space-y-4 mb-8">
                    ...
                    <p className="text-sm text-text-dim font-medium leading-relaxed italic line-clamp-3">
                      "{t.bio || 'Sin descripción disponible.'}"
                    </p>
                  ...
                  <button className="w-full py-5 bg-white/5 hover:bg-primary text-white font-black uppercase tracking-[0.2em] text-[10px] rounded-2xl border border-white/5 hover:border-primary transition-all shadow-sm flex items-center justify-center gap-2 group/btn active:scale-95">
